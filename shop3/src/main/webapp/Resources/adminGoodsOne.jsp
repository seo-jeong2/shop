...
<table border="1">
	...
	<tr>
		...
		<td><a href="<%=request.getContextPath()%>/Resources/updateGoodsForm.jsp?goodsNo=<%=map.get("goodsNo")%>"><button>수정</button></a></td>
	</tr>
	</tbody>	
</table>
	<a href="<%=request.getContextPath()%>/Resources/adminGoodsList.jsp"><button>뒤로가기</button></a>
