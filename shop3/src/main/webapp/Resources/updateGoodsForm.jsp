...
<body>
	<h1>상품 수정</h1>
	<form action="<%=request.getContextPath()%>/Resources/updateGoodsAction.jsp?goodsNo=<%=map.get("goodsNo")%>"
	...
	<a href="<%=request.getContextPath()%>/adminGoodsOne.jsp?goodsNo=<%=map.get("goodsNo")%>"><button>뒤로가기</button></a>
</body>
</html>