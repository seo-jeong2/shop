...
public class GoodsService {
	...
	// 고객 상품목록
	public List<Map<String, Object>> getCustomerGoodsListByPage(int rowPerPage, int currentPage, int num) throws Exception {
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();

		Connection conn = null;
		conn = new DBUtil().getConnection();// 새로운 객체생성
		this.goodsDao = new GoodsDao();
